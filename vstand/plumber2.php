        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="plumber.php">Plumber Installation</a></li>
                    <li><a href="plumber1.php">Plumber Repair</a></li>
                    <li class="active"><a href="plumber2.php">Plumber Blockage</a></li>
                                                        ...
                                                        <div class='modal-dialog modal-sm'>
                                                            <div class='modal-content'>
                                                                ...
                                                                <div class='modal-body'>
                                                                    <form method='POST' action='quote_plumber_blockage.php'>
