        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="plumber.php">Plumber Installation</a></li>
                    <li><a href="plumber1.php">Plumber Repair</a></li>
                    <li><a href="plumber2.php">Plumber Blockage</a></li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="pre-scrollable" style=" max-height: 75vh;">
                                <table class="table table-responsive table-bordered">
                                    ...
                                    $sql = "SELECT * FROM  plumber_installation  ";
                                        ...
                                        <div class='modal-dialog modal-sm'>
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-body'>
                                                    <form method='POST' action=' quote_plumber_installation.php '>
